...
## Usage
BAMMSC(X, K=4, option=’BAMMSC’,method_cluster_initial="kmeans", method_alpha_initial="Ronning", maxIter.DIMMSC=400, tol.DIMMSC=1e-4, likTol.DIMMSC=1e-2, nBurn=1000, maxIter.BAMMSC=2000, likTol.BAMMSC=1e-10)
...
*  nBurn: number of iterations discarded at the initial portion of the Markov chain, default is 1000
*  maxIter.BAMMSC: maximum number of iterations in MCMC, default is 2000
